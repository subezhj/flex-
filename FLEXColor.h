...
// Liquid Glass Theme Colors (iOS 16+/26+)
@property (readonly, class) UIColor *glassBackgroundColor;
@property (readonly, class) UIColor *glassBorderColor;
@property (readonly, class) UIColor *glassCardBackgroundColor;
